...
using Division.Player; // PlayerHealth 접근용
...
// 공격 시작 부분
        ...
        IEnumerator AttackRoutine(Vector3Int direction)
        {
            ...
            foreach (Vector3 center in targetCenters)
            {
            ...
            // 7. 좀비 AI 다시 가동 (AI가 Update에서 isMoving 등을 체크해서 알아서 움직이게 하거나 명시적 호출)
            // zombieAI.ResumeChasing(); // 이런 식의 함수가 있다면 호출
        }
